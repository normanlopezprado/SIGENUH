        ...
        <div class="row g-4 mb-5">
          ...
          <div class="col-12 col-sm-4">
            ...
            <label for="compactSidebar" class="switcher-card w-100">
              ...
              <span class="d-block shadow-none fs-12 fw-semibold text-center pt-2">Compacto</span>
            </label>
          </div>
          <div class="col-12 col-sm-4">
            <!-- SMALL ICON -->
            ...
            <label for="smallIconSidebar" class="switcher-card w-100">
              ...
              <span class="d-block shadow-none fs-12 fw-semibold text-center pt-2">Iconos pequeños</span>
            </label>
          </div>
        </div>
      </div>
