...
function renderChart() {
        ...
        charts.myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    fill: false,
                    borderColor: getBootstrapVariable('--bs-primary'), // Get fresh color
                    backgroundColor: getBootstrapVariable('--bs-primary'), // Get fresh color
                    borderWidth: 1
                }]
            },
            options: {
    ...
    if (barChartCanvas) {
        ...
        charts.barChart = new Chart(ctx1, {
            type: 'bar',
            data: {
    ...
    if (horizontalBarChartCanvas) {
        ...
        charts.horizontalBarChart = new Chart(ctx1, {
    ...
    if (polarChartCanvas) {
        ...
        charts.polarChart = new Chart(ctx1, {
            type: 'polarArea',
            data: {
    ...
    if (pieChartCanvas) {
        ...
        charts.pieChart = new Chart(ctx1, {
            type: 'pie',
            data: {
    ...
    if (stackedLineChartCanvas) {
        ...
        // Destroy the existing chart if it exists
        if (charts.stackedLineChart) {
            charts.stackedLineChart.destroy();
        }
        charts.stackedLineChart = new Chart(ctx1, {
    ...
    if (radarChartCanvas) {
        ...
        charts.radarChart = new Chart(ctx1, {
            type: 'radar',
            data: {
    ...
    if (lineAreaChartCanvas) {
        ...
        // Destroy the existing chart if it exists
        if (charts.lineAreaChart) {
            charts.lineAreaChart.destroy();
        }
        charts.lineAreaChart = new Chart(ctx1, {
    ...
    if (doughnutChartCanvas) {
        ...
        charts.doughnutChart = new Chart(ctx1, {
